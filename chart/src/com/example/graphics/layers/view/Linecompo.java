...
public class Linecompo extends compo {
	...
	private void drawK(Canvas canvas) {
			...
			float stickWidth = ((float)(super.getWidth() - 48)/ StickSumDisplay);
			...
			if (null != d) {
				for(int i = beginIndex;i<beginIndex+StickSumDisplay;i++){
				//for (int i = 0; i < d.getListEntity().size(); i++) {
					...
					*/
					...
					if(stickWidth < 1){
						...
						//{
							i=i+(int)(1/stickWidth);
							stickX = stickX + stickWidth*(int)(1/stickWidth);
						//}
					}
				}
			}
